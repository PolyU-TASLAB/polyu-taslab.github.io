...
{% include figure.html image="images/news/20260807_david_rosen_visit/hku_peng_lu_group.jpg" caption="Prof. Peng LU, Prof. David M. Rosen, and Prof. Weisong WEN during the HKU laboratory visit." width="850px" %}

{% include figure.html image="images/news/20260807_david_rosen_visit/hku_robotics_lab.jpg" caption="Viewing robotic hardware and exchanging perspectives during the visit to Prof. Peng LU's laboratory." width="600px" %}
...
{% include figure.html image="images/news/20260807_david_rosen_visit/topometric_navigation_discussion.jpg" caption="A TASLAB research discussion on graph navigation using topometric memory." width="850px" %}
...
{% include figure.html image="images/news/20260807_david_rosen_visit/safe_learning_discussion.jpg" caption="Discussing uncertainty-aware reinforcement learning and the limitations of existing safety-constrained methods." width="850px" %}
