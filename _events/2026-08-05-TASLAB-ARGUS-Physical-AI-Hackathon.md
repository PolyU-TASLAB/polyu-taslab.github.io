---
title: TASLAB Students Win OpenWonderLabs Track Championship at Hong Kong's Inaugural Physical AI Hackathon
subtitle:
# author:
...
## TASLAB Students Win OpenWonderLabs Track Championship at Hong Kong's Inaugural Physical AI Hackathon

Four PhD students from the Trustworthy AI and Autonomous Systems Laboratory (TASLAB) at The Hong Kong Polytechnic University (PolyU) - XU Ruijie, Feng Yu, Xiao Naigui, and Wang Xin - won the championship of the OpenWonderLabs "Third Hand" Track at Hong Kong's inaugural Physical AI Hackathon. The 48-hour competition culminated on August 5, 2026, at the Charles K. Kao Auditorium in Hong Kong Science Park.
...
<div style="text-align: center; margin-bottom: 20px;">
  ...
  <p style="font-size: 14px; color: #666; margin-top: 8px; text-align: center;">TASLAB PhD students XU Ruijie, Feng Yu, Xiao Naigui, and Wang Xin at Hong Kong's inaugural Physical AI Hackathon.</p>
</div>
...
<div style="text-align: center; margin-bottom: 20px;">
  <img src="{{ '/images/news/20260805_physical_ai_hackathon/argus_robot_demo.jpg' | relative_url }}" alt="ARGUS using an OpenWonderLabs A1-R robotic arm to photograph participants"
       style="width: 100%; height: auto; object-fit: contain; max-width: 850px; margin: 0 auto; border-radius: 15px;">
  <p style="font-size: 14px; color: #666; margin-top: 8px; text-align: center;">ARGUS uses an OpenWonderLabs A1-R robotic arm and a camera node to autonomously compose and capture portraits.</p>
</div>
...
<div style="text-align: center; margin-bottom: 20px;">
  <img src="{{ '/images/news/20260805_physical_ai_hackathon/argus_award_ceremony.jpg' | relative_url }}" alt="The TASLAB team receiving the OpenWonderLabs Third Hand Track championship award"
       style="width: 100%; height: auto; object-fit: contain; max-width: 850px; margin: 0 auto; border-radius: 15px;">
  <p style="font-size: 14px; color: #666; margin-top: 8px; text-align: center;">The TASLAB team receives the championship award for the OpenWonderLabs "Third Hand" Track.</p>
</div>
