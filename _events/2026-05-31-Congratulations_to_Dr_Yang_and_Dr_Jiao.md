...
image: images/news/celebration.png
tags: news
order:
---
...
<div style="text-align: center; margin-bottom: 20px;">
  <img src="https://github.com/PolyU-TASLAB/polyu-taslab.github.io/raw/main/images/news/celebration.png" alt="Dr. Runqiu Yang"
       style="width: 90%; height: auto; object-fit: cover; max-width: 850px; margin: 8px; border-radius: 15px;">
  <p style="text-align: center;font-size: 14px; color: #666; margin-top: 8px;">Warm congratulations to Dr. Runqiu Yang and Dr. Jianhao Jiao.</p>
</div>
