...
<div style="text-align: center; margin-bottom: 20px;">
  <video controls playsinline preload="metadata" poster="{{ '/images/news/20260305_deep_space_robotics/video_cover.jpg' | relative_url }}"
         style="width: 100%; height: auto; max-width: 850px; border-radius: 15px;">
    <source src="{{ '/images/news/20260305_deep_space_robotics/stodownload.mp4' | relative_url }}" type="video/mp4">
    Your browser does not support the video tag.
  </video>
  <p style="text-align: center;font-size: 14px; color: #666; margin-top: 8px;">Video feature on PolyU deep-space robotics and Prof. WEN's team.</p>
</div>
