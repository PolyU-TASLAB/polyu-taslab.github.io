...
<div style="text-align: center; margin-bottom: 20px;">
  ...
  <p style="font-size: 14px; color: #666; margin-top: 8px;">TASLAB demonstrates an indoor drone garment pickup and transport task.</p>
</div>
...
<div style="text-align: center; margin-bottom: 20px;">
  ...
  <p style="font-size: 14px; color: #666; margin-top: 8px;">A second demonstration run shows the drone approaching the garment, lifting it, and returning toward the target area.</p>
</div>
...
<div style="text-align: center; margin-bottom: 20px;">
  <img src="{{ '/images/news/20260630_housing_cr/3.jpg' | relative_url }}" alt="Visitors learning about TASLAB experimental platforms"
       style="width: 100%; height: auto; object-fit: contain; max-width: 850px; margin: 0 auto; border-radius: 15px;">
  <p style="font-size: 14px; color: #666; margin-top: 8px;">The visitors tour TASLAB and learn about its research platforms and experimental facilities.</p>
</div>
...
<div style="text-align: center; margin-bottom: 20px;">
  <img src="{{ '/images/news/20260630_housing_cr/4.jpg' | relative_url }}" alt="TASLAB team introducing autonomous robotic platforms to the visitors"
       style="width: 100%; height: auto; object-fit: contain; max-width: 850px; margin: 0 auto; border-radius: 15px;">
  <p style="font-size: 14px; color: #666; margin-top: 8px;">The TASLAB team introduces autonomous robotic platforms and related research facilities during the laboratory tour.</p>
</div>
