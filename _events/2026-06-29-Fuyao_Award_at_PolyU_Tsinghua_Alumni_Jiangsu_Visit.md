...
<div style="text-align: center; margin-bottom: 20px;">
  <img src="{{ '/images/news/20260629_jiangsu_alumni/fuyao_award.jpg' | relative_url }}" alt="TASLAB project receives the Fuyao Award"
       style="width: 100%; height: auto; object-fit: contain; max-width: 850px; margin: 0 auto; border-radius: 15px;">
  <p style="font-size: 14px; color: #666; margin-top: 8px;">TASLAB's intelligent UAV facade cleaning project receives the Fuyao Award.</p>
</div>

<div style="text-align: center; margin-bottom: 20px;">
  <img src="{{ '/images/news/20260629_jiangsu_alumni/product_introduction.jpg' | relative_url }}" alt="TASLAB introduces UAV and intelligent system technologies to guests"
       style="width: 100%; height: auto; object-fit: contain; max-width: 850px; margin: 0 auto; border-radius: 15px;">
  <p style="font-size: 14px; color: #666; margin-top: 8px;">TASLAB introduces UAV, navigation, and intelligent system technologies to guests during the exhibition.</p>
</div>

<div style="text-align: center; margin-bottom: 20px;">
  <img src="{{ '/images/news/20260629_jiangsu_alumni/project_posters.jpg' | relative_url }}" alt="TASLAB project and product posters at the exhibition"
       style="width: 100%; height: auto; object-fit: contain; max-width: 850px; margin: 0 auto; border-radius: 15px;">
  <p style="font-size: 14px; color: #666; margin-top: 8px;">TASLAB showcases its intelligent UAV facade cleaning system, GNSS/IMU boards, DroneExplorer UAV, and UWB devices.</p>
</div>

<div style="text-align: center; margin-bottom: 20px;">
  <img src="{{ '/images/news/20260629_jiangsu_alumni/award_group.jpg' | relative_url }}" alt="Award recipients at the PolyU industry-university-research achievements exhibition"
       style="width: 100%; height: auto; object-fit: contain; max-width: 850px; margin: 0 auto; border-radius: 15px;">
  <p style="font-size: 14px; color: #666; margin-top: 8px;">Award recipients at the PolyU industry-university-research achievements exhibition.</p>
</div>
